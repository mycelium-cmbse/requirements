...
| SSS-FG-AUTH-E7N | IA | Mycelium Forge shall prevent any principal other than the Installation Administrator from erasing a published package version, shall unlist rather than delete where a package has recorded downloads or dependants, and shall record every erasure in the audit log, when "a principal requests the deletion of a package or a published version." | - | H |
